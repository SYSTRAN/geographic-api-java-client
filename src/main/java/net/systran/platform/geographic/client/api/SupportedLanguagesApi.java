...
public class SupportedLanguagesApi {
   ...
   */
  public SupportedLanguagesResponse geographicSupportedLanguagesGet (String callback) throws ApiException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/geographic/supportedLanguages".replaceAll("\\{format\\}","json");
